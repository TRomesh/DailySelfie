...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static String POST_TABLE =
            "CREATE TABLE posts (id INTEGER PRIMARY KEY AUTOINCREMENT, description TEXT, height DOUBLE, weight DOUBLE, waistSize DOUBLE, created_at DATETIME DEFAULT CURRENT_TIMESTAMP,image VARCHAR(500), alram DATETIME,challangeName VARCHAR(250), FOREIGN KEY (challangeName) REFERENCES challanges(name) )";
